...
try:
    from remote_machine_wmi import WmiRemoteMachine
except Exception, e:
    print '*DEBUG* Unable to import remote_machine_wmi! (%s)' % str(e)
    WmiRemoteMachine = None
    
try:
    from remote_machine_ssh import SshRemoteMachine
except Exception, e:
...
class RemoteMachine(object):
    ...
    def __getattr__(self, attr):
        ...
        """
        return getattr(self.remote_machine, attr)
